...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out_layer_1 = self.layer1(out)
        out_layer_2 = self.layer2(out_layer_1)
        out_layer_3 = self.layer3(out_layer_2)
        out_layer_4 = self.layer4(out_layer_3)

        out = self.avgpool(out_layer_4).reshape(x.shape[0], -1)
        out = self.linear(out)

        return out, out_layer_1, out_layer_2, out_layer_3, out_layer_4
